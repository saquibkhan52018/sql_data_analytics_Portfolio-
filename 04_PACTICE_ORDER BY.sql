...
--  DAY_04 _ PRACTICE_ORDER BY  --


-- Q01 DISPLAY ALL EMLPOYEE SHORTED BY SALARY IN DESENDING ORDER -- 
select * from employees order by salary desc;


-- Q2 DISPLAY ALL EMPLOYEE SHORTED BY SALARY IN DESENDING ORDER --
select * from employees order by salary asc;


-- Q3 DISPLAY EMPLOYEE SHORTED BY AGE FROM YOUNGEST TO OLDEST --
select * from employees order by age asc;


-- Q4 DISPLAY EMPLOYEE SHORTED BY AGE FROM OLDEST TO YOUNGEST --
select * from employees order by age desc;


-- Q5 DISPLAY EMPLOYEE NAME SHORTED BY ALPHABETICALLY --
select * from employees order by emp_name asc;


-- Q6 DISPLAY EMPLOYEE NAMES IN REVERSE ALPHABETICAL ORDER --
select * from employees order by  emp_name desc;


-- Q7 DISPLAY EMPLOYEE SHORTED  BY DEPARTMENT ALPHABETICALLY --
select * from employees order by department asc;


-- Q8 DISPLAY EMPLOYEE SHORTED BY CITY ALPHABETICALLY --
select * from employees order by city asc;


-- Q9 DISPLAY ONLY EMPLOYEE NAMES AND SALARY SHORTED BY DESCENDING  ORDER --
select emp_name , salary from employees order by salary desc;


-- Q10 DASPLAY EMPLOYEE NAME AND AGES SHORTED BY AGE ASCENDING --
select emp_name , age from employees order by age asc;


-- Q11 DISPLAY EMPLOYEE SHORTED BY DEPARTMENT AND SALARY 
select * from employees order by department asc , salary desc;
select department , salary from employees order by department asc , salary desc;


-- Q12 SORT EMPLOYEE BY CITY ASCEDING AND SALARY DESCINDING --
select * from employees order by city asc , salary desc ;


-- Q13 SORT EMPLOYEE BY DEPARTMENT ASCENDING AND AGE DESCENDING --
select * from employees order by department asc,age desc;


-- Q14 DISPLAY THE HIGEST_PAID EMPLOYEE FIRST --
select * from employees order by salary desc;


-- Q15 DISPLAY THE LOWEST_SALARY EMPLOYEE FIRST --
select * from employees order by salary asc;


-- Q16 DISPLAY THE OLDEST EMPLOYEE FIRST --
select * from employees order by age desc;


-- Q17 DISPLAY THE YOUNGEST EMPLOYEE FIRST --
select * from employees order by age asc;


-- Q18 DISPLAY EMPLOYEE FROM MUMBAI SHORTED BY SALARY DESCENDING --
select * from employees where city='Mumbai' order by salary desc;


-- Q19 DISPLAY EMPLOYEE FROM THE IT DEPARTMENT SHORTED BY SALARY DESCENDING --
select * from employees where department='IT' order by salary desc;


-- Q20 DISPLAY EMPLOYEE FROM HR SORTED BY AGE ASCENDING --
select * from employees where department='HR' order by age asc;


-- Q21 DISPLAY EMPLOYEES FROM SALES SORTED BY ALPHABETICALLY --
select emp_name,department , salary from employees where department='Sales' order by emp_name asc; 


-- Q22 DISPLAY EMPLOYEE FROM DELHI SORTED BY SALARY ASC --
select * from employees where city='Delhi' order by salary asc;


-- Q23 DISPLAY EMPLOYEE EARNING MORE THAN 350000 HIGEST SALARY FIRST  --
select * from employees WHERE SALARY>35000  ORDER BY AGE DESC;


-- Q24 DISPLAY EMPLOYEE YOUNGER THAN 25 SORTED BY AGE ASCENDING --
select * from employees where age<26 order by age asc;


-- Q25 DISPLAY EMPLOYEE AGE 24 OR ABOVE SORTED BY SALARY DESCENDONG --
select * from employees where age>=24 order by salary desc;


  --    ORDER BY + LIMIT USES -- 
  
  
  -- Q26 DISPLAY THE TOP 5 HIGEST SALARY PAID EMPLOYEE --
  select * from employees order by salary desc limit 5;
  
  
  -- Q27 DISPLAY THE TOP 3 HIGHEST PAID EMPLOYEES --
select * from employees order by salary desc limit 3;


-- Q28 DISPLAY THE 3 LOWEST PAID SALARY --
select * from employees order by salary asc limit 3;  


-- Q29 DISPLAY THE 2 OLDEST EMPLOYEES --
select * from employees order by age desc limit 2;  


-- Q30 DISPLAY THE 3 YOUNGEST EMPLOYEES --
select * from employees order by age asc limit 3;


-- Q31 DISPLAY THE TOP 5 EMPLOYEES FROM MUMBAI BY SALARY --
select * from employees where city='Mumbai' order by salary desc limit 5;


-- Q32 DISPLAY THE TOP 3 HIGHEST PAID IT EMPLOYEES --
select * from employees where department='IT' order by salary desc limit 3;


-- Q33 DISPLAY THE TOP 2 HIGHEST PAID HR EMPLOYEES --
select * from employees where department='HR' order by salary desc limit 2 ;


-- Q34 DISPLAY THE LOWEST PAID EMPLOYEES FROM SALES --
select * from employees where department='Sales' order by salary asc limit 2;


-- Q35 DISLAY THE HIGHEST PAID EMPLOYEES FROM FINANCE --
select * from employees where department='Finance' order by salary asc limit 1;


-- Q36 DISPLAY MUMBAI EMPLOYEES AGED ABOVE 23 SORTED BY SALARY DESC --
select * from employees where city='Mumbai' and age>23 order by salary desc; 


-- Q37 DISPLAY IT EMPLOYEES EARNING MORE THAN 30000 SORTED BY SALARY DESC --
select * from employees where department='IT' and salary>30000 order by salary desc;


-- Q38 DISPLAY EMPLOYEES FROM DELHI OR MUMBAI SORTED BY SALARY DESC -- 
select * from employees where city in ('Delhi','Mumbai') order by salary desc;


-- Q39 DISPLAY EMPLOYEES WHOSE SALARY IS BETWEEN 30000 AND 45000 SORTED BY SALARY ASC --
select * from employees where salary between 30000 and 45000 order by salary asc; 


-- Q40 DISPLAY EMPLOYEES WHOSE AGE IS BETWEEN 22 AND 26 SORTED BY AGE DESC --
select * from employees where age between 22 and 26 order by age desc;


-- Q41 DISPLAY THE TOP 3 HIGHEST PAID EMPLOYEES IN MUMBAI --
select * from employees where  city='Mumbai' order by salary desc limit 3;


-- Q42 DISPLAY THE TOP 2 OLDEST EMPLOYEES IN IT --
select * from employees where department='IT' order by age desc limit 2;


-- Q43 DISPLAY THE 3 YOUNGEST EMPLOYEES EARNING MORE THAN 30000 --
select * from employees  where salary>30000 order by age asc limit 3;


-- Q44 DISPLAY THE TOP 3 SALARY AMONG EMPLOYEES AGE ABOVE 23 --
select * from employees where age>23 order by salary desc limit 3;
select emp_name , salary , age from employees where age>23 order by salary desc limit 3;                  
  
  
-- Q45 DISPLAY EMPLOYEES FROM HR OR FINACE SORTED BY SALARY FROM HIGHEST TO LOWEST --
select * from employees where department in ('HR','Finance') order by salary desc;


-- Q46 DISPLAY EMPLOYEES FROM MUMBAI WITH SALARY ABOVE 30000 HIGHEST SALARY FIRST --
select * from employees where city='Mumbai' and salary>30000 order by salary desc;


-- Q48 DISPLAY ALL EMPLOYEES SORTED FIRST BY DEPARTMENT AND THEN BY SALARY DESC --
select * from employees order by department asc , salary desc;


-- Q49 DISPLAY THE TOP 5 EMPLOYEES BY SALARY SHOWING ONLY NAME AND SALARY --
select emp_name,salary from employees order by salary desc limit 5 ;


-- Q50 DISPLAY THE TOP 3 EMPLOYEES FROM IT OR FINANCE BASED ON SALARY --
select * from employees where department in('IT','Finance') order by salary limit 3;
